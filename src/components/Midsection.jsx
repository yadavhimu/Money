    ...
    <div className="lg:px-[7vw] mt-20">
      <div className="w-full flex">
        <div className="w-full mt-5 p-2">
          <p className=" flex text-5xl font-medium text-green-600">Money is waiting for you, wherever you are</p>
      ...
      <div className="mt-20 lg:px-[7vw]">
       ...
       <p className="flex justify-center text-2xl mt-5  text-green-900 font-medium">Same Day Funding is Possible</p>

       <div>
        <div className="flex justify-between mt-16">
            <div className="w-[350px] border-2 border-gray-300 shadow-2xl p-2">
